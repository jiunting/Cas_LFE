                ...
                for k in avail_k:
                    ...
                    if 'stack' in templates[k]:
                        for i_comp in use_comp:
                            ...
                            tmp_stacked_d = templates[k]['tmp_data'][i_comp][ii:ii+int(template_length*sampl+1)] - np.mean(templates[k]['tmp_data'][i_comp][ii:ii+int(template_length*sampl+1)])
                            tmp_stacked_d = tmp_stacked_d/np.max(np.abs(tmp_stacked_d))
                            templates[k]['stack'][i_comp] += tmp_stacked_d
                        ...
                        for i_comp in use_comp:
                            ...
                            tmp_stacked_d = templates[k]['tmp_data'][i_comp][ii:ii+int(template_length*sampl+1)]
                            tmp_stacked_d = tmp_stacked_d/np.max(np.abs(tmp_stacked_d))
                            templates[k]['stack'][i_comp] = templates[k]['template'][i_comp]/np.max(np.abs(templates[k]['template'][i_comp])) + tmp_stacked_d
